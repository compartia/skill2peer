...
<div style="background: url('http://38.media.tumblr.com/cc3f65bbff01b690d3d92521482ba234/tumblr_ngx7tsUvOI1rdqbfro5_1280.gif'); background-position:center; background-size: cover">
	<div class="image-fade-out-cover">
		<div class="row row-md-height">
			...
			<div class="col-md-4 col-md-pull-8 col-md-height" style="padding: 10px;">
							...
							<div class="course-options">
								...
								<div class="course-place-wrap" itemprop="location" itemscope itemtype="http://schema.org/Place">
									<div class="course-place">
										...
										<small>${course.location.description}</small>
									</div>
								</div>
