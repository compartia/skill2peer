...
<div class="page-header-wrap" style="background: url(/static/img/tkLOe7nnQ7mnMsiuijBy_hm.jpg); background-size: cover">
	<header class="page-header mobile-view">
	...
	<header class="page-header desktop-view">
		<div class="page-header-inner">
			<div class="content">
				...
				<ul class="skills-list">
					<c:forTokens items="${course.skills}" delims="," var="name">
						<li><span class="label label-default"><span class="fa fa-circle fa-my-tag"></span> ${name} </span></li>
					</c:forTokens>
				</ul>
			</div>
		</div>
